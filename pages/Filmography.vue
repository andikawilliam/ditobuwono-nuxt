<template>
  <Main>
    <div class="relative px-8 md:px-20 lg:px-20 xl:pb-0">
  ...
  data() {
    return {
      ...
      description: `
        ...
        are the short films that he has starred in. After a long time, on the 1st of September 2020, 
      ...
      films: [
        {
          id: 1,
          image: require("~/assets/ss-gerajak.jpeg"),
          title: "Gerajak (2021)",
        ...
        {
          id: 2,
          image: require("~/assets/ss-belrusak.webp"),
          title: "Belrusak (2020)",
          type: "Short Documentary Film",
          role: "Role: Director",
          accolades: [
            "Best Documentary October Edition Feel The Reel International Film Festival 2020",
            "Top 25 Short Documentaries Recommended by the Association from Festival Film Indonesia 2021",
        ...
        {
          id: 3,
          image: require("~/assets/ss-menyusulmu.webp"),
        ...
        {
          id: 4,
          image: require("~/assets/ss-terbelenggu.webp"),
